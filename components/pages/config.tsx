      ...
      <Animate transitionName="fadeandzoom" transitionAppear>
        <div>
            ...
            <NodeMetadataOverview>
              ...
              <VersionInformationDisplay>
                <dl>
                  <dt>
                    <BareLink
                      href="https://github.com/horizonio/webnetesctl"
                      target="_blank"
                    >
                  ...
                  <dt>
                    <BareLink
                      href="https://github.com/horizonio/webnetes"
                      target="_blank"
                    >
          ...
          <MoreLink>
            ...
            <a
              href="https://github.com/horizonio/webnetes/blob/main/app/webnetes_node/node.yaml"
              target="_blank"
            >
